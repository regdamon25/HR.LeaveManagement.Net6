...
{
    public class MVCAuthService : BaseHttpService , IMVCAuthService
    {
            ...
            : base(client, localStorage)
        {
            ...
            _tokenHandler = new JwtSecurityTokenHandler(); //Not being injected but rather initializing it to be a new instance of
        ...
        public async Task<bool> Authenticate(string email, string password)
        {
            try
            {
                AuthRequest authenticationRequest = new() { Email = email, Password = password }; //Creating new instance of AuthRequest Object
